...
import MyChessGame.gamemode.CheckmateDetector;
...
public class Board extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private static final String RESOURCES_WBISHOP_PNG = "pieces/wbishop.png";
    private static final String RESOURCES_BBISHOP_PNG = "pieces/bbishop.png";
    private static final String RESOURCES_WKNIGHT_PNG = "pieces/wknight.png";
    private static final String RESOURCES_BKNIGHT_PNG = "pieces/bknight.png";
    private static final String RESOURCES_WROOK_PNG = "pieces/wrook.png";
    private static final String RESOURCES_BROOK_PNG = "pieces/brook.png";
    private static final String RESOURCES_WKING_PNG = "pieces/wking.png";
    private static final String RESOURCES_BKING_PNG = "pieces/bking.png";
    private static final String RESOURCES_BQUEEN_PNG = "pieces/bqueen.png";
    private static final String RESOURCES_WQUEEN_PNG = "pieces/wqueen.png";
    private static final String RESOURCES_WPAWN_PNG = "pieces/wpawn.png";
    private static final String RESOURCES_BPAWN_PNG = "pieces/bpawn.png";
